...
public class Users extends BaseEntity {
    ...
    private Collection<Ebook> ebooksByUserId;

    @OneToMany(mappedBy = "usersByUserId")
    private Collection<UsersLibraries> usersLibrariesByUserId;
    ...
    public Collection<Ebook> getEbooksByUserId() {
        return ebooksByUserId;
    }

    public void setEbooksByUserId(Collection<Ebook> ebooksByUserId) {
        this.ebooksByUserId = ebooksByUserId;
    }

    public Collection<UsersLibraries> getUsersLibrariesByUserId() {
        return usersLibrariesByUserId;
    }

    public void setUsersLibrariesByUserId(Collection<UsersLibraries> usersLibrariesByUserId) {
        this.usersLibrariesByUserId = usersLibrariesByUserId;
    }
}
